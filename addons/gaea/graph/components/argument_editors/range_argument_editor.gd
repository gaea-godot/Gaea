...
func _configure() -> void:
	...
	range_slider.allow_lesser = allow_lesser
	range_slider.allow_greater = allow_greater
	...
	_configure_min_max_spin_box()

	await super()


func _configure_min_max_spin_box() -> void:
	...
	min_spin_box.allow_lesser = range_slider.allow_lesser
	min_spin_box.allow_greater = range_slider.allow_greater
	max_spin_box.allow_lesser = range_slider.allow_lesser
	max_spin_box.allow_greater = range_slider.allow_greater
